              ...
              >
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Do cashiers appear properly trained to handle the task?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Do all cashiers have functional POS terminals for payment collection?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are cashier activities being actively supervised by a manager/supervisor/security?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are customers serviced within 3 minutes? (Confirm queue/checkout time per customer)</p>
