      ...
      <div class="md-layout-item md-size-100">
        ...
        <md-card>
          <md-card-header data-background-color="orange">
            <h4 class="title">Loss Prevention</h4>
          </md-card-header>
          <md-card-content>
            <form
              id=""
            ...
            >
              ...
              >
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Does location have a functioning alarm system? Test same yourself please</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is alarm code known to others apart from opening manager(s)?</p>
             ...
             <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Does location have a key control log for all store keys?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are CCTV operators on time, manning their station, vigilant and well behaved?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are all cameras functional?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Does the delivery area have a functional camera?</p>
                 ...
                 <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are high theft items secured and properly policed?</p>
                 ...
                 <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Does location conduct regular stock counts? Are results satisfactory?</p>
                 ...
                 <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are damaged/defective inventory kept secure and orderly?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are staff restricted from performing self or family purchases?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Who performs high risk actions on the POS e.g. refunds etc</p>
...
export default {
  ...
  methods: {
    saveContinue () {
      this.submitForm()
      this.$router.push({ path: 'store_opening' })
