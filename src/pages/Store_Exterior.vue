              ...
              >
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are all signages clean and in good working conditions?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are customers entrance and exit door in good working condition with safety signs on them?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are the floor tiles properly cleaned and in good condition?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is waste stored in appropriate waste or recycling storage areas?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is the property kept clear of litter, organic waste, hazardous materials, etc?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are the electrical panels and distribution boxes closed/secured from external access?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are there any unplanned organic growths (e.g.algae etc) in the premises - check corners?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are there any electrical cables or switches exposed and presenting a clear and present danger to the public?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are there areas of the building exterior that require maintenance?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are the back areas free from liter and kept clean and free of smells?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are security personel stationed at their respective beats?</p>
