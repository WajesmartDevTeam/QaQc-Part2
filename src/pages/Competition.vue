              ...
              >
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are there any competitor prices of note?</p>
                     ...
                     <div class="form-check-inline yes_no" id="4" data-name="Are there any competitor prices of note?">
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <div class="form-check-inline yes_no" id="5" data-name="Any activation in competing stores">
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are there any new competitors or competitor activities in the area?</p>

                    <div class="form-check-inline yes_no" id="6" data-name="Are there any new competitors or competitor activities in the area?">
