      ...
      <div class="md-layout-item md-size-100">
        ...
        <md-card>
          <md-card-header data-background-color="orange">
            <h4 class="title">Store Opening</h4>
          </md-card-header>
          <md-card-content>
            <form
              id=""
            ...
            >
              ...
              >
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is opening manager on time?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Did manager do an exterior walkaround in company of security?</p>
             ...
             <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Did manager do an interior walkaround in company of security?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are staff/managers allowed to bring in bags to the shopfloor?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is menu on display at the time of opening to customers?</p>
                 ...
                 <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is store clean at the time of opening the shop to customers?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are security at their respective beats at the time of opening the shop to customers?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are all crew at their respective stations at the time of opening the shop to customers?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is merchandise display in good enough condition at the time of opening the shop to customers?</p>
...
export default {
  ...
  methods: {
    saveContinue () {
      this.submitForm()
      this.$router.push({ path: 'store_closing' })
