      ...
      <div class="md-layout-item md-size-100">
        ...
        <md-card>
          <md-card-header data-background-color="orange">
            <h4 class="title">Store Closing</h4>
          </md-card-header>
          <md-card-content>
            <form
              id=""
              ...
              >
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Did manager commence search of building interior ahead of closing time? </p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is checkout manager actively managing the checkout close out process?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Did store manager close the store doors at the appointed closing time?</p>
...
export default {
  ...
  methods: {
    saveContinue () {
      this.submitForm()
      this.$router.push({ path: 'night_time' })
