              ...
              >
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are there categories we can improve range and stocking</p>
                    
                    <div class="form-check-inline yes_no" id="4" data-name="Are there categories we can improve range and stocking">
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are there new product lines that can be introduced to store</p>

                    <div class="form-check-inline yes_no" id="5" data-name="Are there new product lines that can be introduced to store">
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are there events we can do to increase footfall to the store</p>

                    <div class="form-check-inline yes_no" id="6" data-name="Are there events we can do to increase footfall to the store">
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <div class="form-check-inline yes_no" id="7" data-name="Are there categories we can improve range and stocking">
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is there room for a differentiated offering in the market</p>

                    <div class="form-check-inline yes_no" id="8" data-name="Is there room for a differentiated offering in the market">
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are there any other opportunities for improved sales at this store?</p>

                    <div class="form-check-inline yes_no" id="9" data-name="Are there any other opportunities for improved sales at this store">
                ...
                >
                  <label
                    ...
                    <textarea rows="5" cols= "138" class="form-box" type="text" ></textarea>
                </div>
