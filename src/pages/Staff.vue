              ...
              >
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Do all staff clock in/out at start/close of business?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are there enough staff on schedule to assist customers per shift?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is management schedule followed strictly?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are all staff and management in correct uniform with a name tags?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are all staff looking good with the appropriate dressing, grooming and hair standards?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is the checkout manned by enough cashiers and a manager?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Do staff have good customer service and selling skills?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are all staff friendly and welcoming to customers?</p>
...
export default {
  ...
  methods: {
    saveContinue () {
      this.submitForm()
      this.$router.push({ path: 'opportunities' })
