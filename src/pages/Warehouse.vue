             ...
             <md-card class="md-raised">
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is access to the warehouse limited (particularly from the outside)?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is receiving manager receiving in company of audit and security per policy?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is receiving manager checking each individual item for conformity with LPO and for expiration date?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are cartons marked with date of receipt and name of receiver?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Do you see any control risks with the warehouse operations?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is receiving area free from debris and loose merchandise?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is temperature of the warehouse within acceptable limits (for the benefit of the merchandise stored therein)?</p>
