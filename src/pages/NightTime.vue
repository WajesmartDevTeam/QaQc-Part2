      ...
      <div class="md-layout-item md-size-100">
        ...
        <md-card>
          <md-card-header data-background-color="orange">
            <h4 class="title">Night Time Visitation</h4>
          </md-card-header>
          <md-card-content>
            <form
              id=""
              ...
              >
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is the building exterior properly lit? Check that all flood lights are functioning at full capacity </p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is store properly lit internally?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are the signages all functional?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Are the security personel / mopol active at their respective beats?</p>
                ...
                <md-card class="md-raised">
                  <md-card-content>
                    ...
                    <p>Is staff entrance door locked/secure and staff are not allowed unfettered exit to the building around this period?</p>
